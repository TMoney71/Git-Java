...
let foods = ['Strawbarries', ' Tacos', ' Pancakes', ' Chicken Alfredo'];
...
let otherfoods = ' The Chicken Stuff'

// Step 4: add the variable holding another favorite food to the favorite food array
foods.push(otherfoods);
