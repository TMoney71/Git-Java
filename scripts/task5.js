...
else (message1 = 'Wooho! It is the weekend!')
/* SWITCH, CASE, BREAK */
...
const output = (temple) => {
    temple.forEach(
        temple => {
            ...
            location.textContent = temple.loaction;

            let dedicated = document.createElement('h5');
            ...
            artical.appendChild(templeName);
            artical.appendChild(location);
            artical.appendChild(dedicated);
            artical.appendChild(img);

            document.querySelector('#temples').appendChild(artical);
        }
    );
}
...
getTemples('templeNameAscending')
/* STRETCH */
